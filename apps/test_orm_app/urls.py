...
from apps.test_orm_app.views.operator_orm_views import  (bulk_create_db_api,query_orm_data_api,query_orm_id_api,query_orm_foreign_key_api,
                                                         query_orm_foreign_key_data,query_orm_model_test,create_orm_model_test)
...
test_orm_app.add_api_route(path="/create_orm_model_test",methods=["GET"],endpoint=create_orm_model_test,summary="添加tortoise-orm的pydantic使用",description="添加tortoise-orm的pydantic使用...",tags=["ORM_OPERATOR增删改查"])
